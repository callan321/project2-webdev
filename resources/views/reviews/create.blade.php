    ...
    <div class="max-w-4xl mx-auto py-10 px-6 bg-white shadow-lg rounded-lg">
        ...
        <form action="{{ route('reviews.store', $assessment->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <select name="reviewee_id" id="reviewee_id" class="block w-full mt-2 rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>
            ...
            <div class="mb-6">
                ...
                <textarea name="code_quality" id="code_quality" rows="3" class="block w-full mt-2 rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>{{ old('code_quality') }}</textarea>
            ...
            <div class="mb-6">
                ...
                <textarea name="code_structure" id="code_structure" rows="3" class="block w-full mt-2 rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>{{ old('code_structure') }}</textarea>
            ...
            <div class="mb-6">
                ...
                <textarea name="coding_style" id="coding_style" rows="3" class="block w-full mt-2 rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>{{ old('coding_style') }}</textarea>
            ...
            <div class="mb-6">
                ...
                <textarea name="testing_debugging" id="testing_debugging" rows="3" class="block w-full mt-2 rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>{{ old('testing_debugging') }}</textarea>
            ...
            <div class="mb-6">
                ...
                <textarea name="documentation" id="documentation" rows="3" class="block w-full mt-2 rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>{{ old('documentation') }}</textarea>
            ...
            <div class="mb-6">
                ...
                <textarea name="areas_for_improvement" id="areas_for_improvement" rows="3" class="block w-full mt-2 rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" required>{{ old('areas_for_improvement') }}</textarea>
            ...
            <div class="mb-6">
                ...
                <textarea name="general_feedback" id="general_feedback" rows="3" class="block w-full mt-2 rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('general_feedback') }}</textarea>
            ...
            @if (auth()->user()->role == 't')
                <div class="mb-6">
                    ...
                    <input type="number" name="score" id="score" class="block w-full mt-2 rounded-md border border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500" min="0" max="{{ $assessment->max_score }}" value="{{ old('score') }}" required>
                </div>
            @endif
